  ...
  updateMetrics: function () {
    ...
    client.info("server" ,function (err, reply) {
      ...
      if (redis_uptime_hours > 48)
        this.probes.redisUptime.set(redis_uptime_days);
      else
        this.probes.redisUptime.set(redis_uptime_hours);
    })
    ...
    client.info("clients" ,function (err, reply) {
      ...
      this.probes.redisClients.set(connected_clients);
    })
    ...
    client.info("stats" ,function (err, reply) {
     ...
     this.probes.redisCmdSec.set(redis_cmd_sec);
      ...
      this.probes.redisHitsSec.set(redis_hits_sec);
      ...
      this.probes.redisMissSec.set(redis_miss_sec);
      ...
      this.probes.redisExpSec.set(redis_expi_sec);
      ...
      this.probes.redisEvtSec.set(redis_evict_sec);
    })
    ...
    client.info("keyspace", function (err, reply) {
      ...
      this.probes.redisKeys.set(redis_keys);
    })
  },
